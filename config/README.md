...
> **Note**: The config templates use an **unversioned** plugin entry (`opencode-openai-codex-key`) so the installer can always pull the latest release. If you need reproducibility, pin a specific version manually.
