...
**Check for updates**: [Releases Page](https://github.com/numman-ali/opencode-openai-codex-key/releases)
...
```json
{
  "plugin": ["file:///absolute/path/to/opencode-openai-codex-key/dist"]
}
```
