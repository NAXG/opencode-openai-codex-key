...
[![npm version](https://badge.fury.io/js/opencode-openai-codex-key.svg)](https://www.npmjs.com/package/opencode-openai-codex-key)
[![Tests](https://github.com/numman-ali/opencode-openai-codex-key/actions/workflows/ci.yml/badge.svg)](https://github.com/numman-ali/opencode-openai-codex-key/actions)
...
- [Release Notes](https://github.com/numman-ali/opencode-openai-codex-key/releases) - Version history and updates
...
```bash
npx -y opencode-openai-codex-key@latest
```

Legacy OpenCode (v1.0.209 and below):

```bash
npx -y opencode-openai-codex-key@latest --legacy
```
...
- **Issues**: [GitHub Issues](https://github.com/numman-ali/opencode-openai-codex-key/issues)
- **Releases**: [Release Notes](https://github.com/numman-ali/opencode-openai-codex-key/releases)
- **Main Repo**: [GitHub](https://github.com/numman-ali/opencode-openai-codex-key)
